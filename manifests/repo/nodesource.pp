...
class am_nodejs::repo::nodesource {
  $enable_src     = $am_nodejs::repo_enable_src
  $ensure         = $am_nodejs::repo_ensure
  $pin            = $am_nodejs::repo_pin
  $priority       = $am_nodejs::repo_priority
  $proxy          = $am_nodejs::repo_proxy
  $proxy_password = $am_nodejs::repo_proxy_password
  $proxy_username = $am_nodejs::repo_proxy_username
